...
_GROUPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("Attribution", ("verdict correctness", "source localisation", "source misdirection")),
...
def as_text(
    ...
    *,
    ...
    lines += [
        ...
        "  Source localisation is a recall and it is deliberately low. akashi names",
        "  the source only where the answer kept the source's digits exactly and",
        "  changed the text beside them. Letting it name one for a value whose",
        "  digits drifted raises this from 12 of 33 to 27 of 33 and is wrong on",
        "  more than half of what it adds, because an invented figure, a derived",
        "  one and a corrupted one are the same thing to anything reading",
        "  structure. Source misdirection is the number that governs and the",
        "  trade was made to hold it at none.",
        "  Twelve is a small number, and each one is a unit_swap plant made by a",
        "  generator that keeps the digits. The precision is measured against the",
        "  other plant kinds; the recall is not independent of the generator.",
        ...
        "  hidden. They are excluded from fabrication recall, which is why that",
        "  figure is a hundred -- so the recall over everything planted is printed",
        "  beside it. A declaration lets a reader adjust what they expect; it does",
        "  not move a denominator, or the cheapest way to improve a rate would be",
        "  to declare more of it out of scope.",
